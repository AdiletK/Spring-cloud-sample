...
Simple crud applications for microservice architecture.

## Used technologies
- Spring Cloud Config (Client and Server)
- Spring Cloud Discovery (Eureka server, Eureka discovery client)
- H2 db
- Spring data jpa
